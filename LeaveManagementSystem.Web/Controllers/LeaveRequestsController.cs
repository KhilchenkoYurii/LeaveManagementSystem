...
namespace LeaveManagementSystem.Web.Controllers
{
    ...
    public class LeaveRequestsController(ILeaveTypesService _leaveTypesService, ILeaveRequestsService _leaveRequestsService) : Controller
    {
        ...
        {
            if (await _leaveRequestsService.CheckDatesExceedAllocation(leaveRequestCreateVM))
            {
                ModelState.AddModelError(string.Empty, "You have exceeded your days allocation!");
                ModelState.AddModelError(nameof(leaveRequestCreateVM.StartDate), "The number of days invalid");
            }
